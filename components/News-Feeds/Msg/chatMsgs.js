            ...
            <div className="col-md-12 p-0">
                {this.props.messages.filter((obj)=> this.filterMsgs(obj)).map((elem,index) => {
                    ...
                    if(elem.sender === this.props.signin){
                        ...
                        return <div   key={index} className="col-md-8  p-0 text-left float-right">
                                    <p className="float-right sendMsg_p mb-1 pl-1 pr-1 p-2">{elem.msg}</p>
                                </div>
                    }
                    else{
                        ...
                        return <div 
                                    key={index} 
                                    className="col-md-8  p-0 text-left float-left">
                                    <p className="mb-1 receiveMsg_p pl-1 pr-1 p-2">{elem.msg}</p>
                                </div>
                    }
                })}
            </div>
